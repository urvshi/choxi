						...
						<div class="col-sm-6 clearfix">
							<div class="form-group row">
									   ...
									   <div class="form-group row">
									    ...
									    <div class="col-sm-9 no_padding_left">
									      <input type="text" class="form-control" name="zip" value="<?php echo $zip; ?>" id="zipCode" data-validation="number length" data-validation-length="5"  data-validation-error-msg="Enter Valid Zip" placeholder="Zipcode">
									      <span class="help-block form-error"></span>
									    </div>
									  </div>
									   <div class="form-group row">
									    ...
									    <div class="form-group row">
									       ...
									       <div class="col-sm-9 no_padding_left">
											  ...
											  <select class="form-control" name="state" id="stateName"  data-validation="length" data-validation-length="1">
<?php										
	$selected='';
